...
import { CloudArrowUpIcon, CogIcon, LockClosedIcon, ServerIcon } from '@heroicons/react/20/solid'
    ...
    return (
        ...
        <section class="bg-center bg-no-repeat bg-[url('https://images.inc.com/uploaded_files/image/1920x1080/getty_849653618_2000132520009280270_344567.jpg')] bg-gray-700 bg-blend-multiply">
            <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
                <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl"> Your Trusted Telecommunication Partner</h1>
