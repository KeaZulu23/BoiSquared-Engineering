...
import motorolapdf from "../Motorola.pdf"
          ...
          <div class="flex flex-wrap -m-4">
            <div class="lg:w-1/3 sm:w-1/2 p-4">
              <div class="flex relative">
                <img alt="gallery" class="absolute inset-0 w-full h-full object-cover object-center" src="https://play-lh.googleusercontent.com/xrAQBO5EeP6FaXdh4cGfadV4jAbqdy-c93pqdpoqXxeQe7jrLjgbn6K1bnQ4hL9T_0s=w600-h300-pc0xffffff-pd"  style={{height: "220px"}}/>
                <div class="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                  <h2 class="tracking-widest text-sm title-font font-medium text-orange-500 mb-1">Our Partners</h2>
                  <h1 class="title-font text-lg font-medium text-gray-900 mb-3">Motorola</h1>
                  <p class="leading-relaxed">Motorola’s diverse array of portable and mobile two-way radios offer solutions that better enable you to efficiently co-ordinate and communicate with your on-the-go workforce.</p>
                  <div>
                    <a href={motorolapdf}>
